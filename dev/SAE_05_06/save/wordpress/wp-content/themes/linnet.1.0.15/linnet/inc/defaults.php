<?php
    ...
    add_action('init', function () {
        add_filter('colibri_theme_title_default_content', function($title) {
            $brite_theme_click_pen_to_edit_title = __('Performance<br>& quality', 'linnet');
        ...
        add_filter('colibri_theme_subtitle_default_content', function($subtitle) {
            return  __(
                'Lorem ipsum dolor sit amet, at mei dolore tritani repudiandae. In his nemore temporibus consequuntur, vim ad prima lorem ipsum sit  vivendum consetetur.',
                'linnet'
            );
        });
    });
	...
	$linnet_theme_divider_style = array(
	...
	$linnet_title = "Performance & quality";
	$linnet_lorem_ipsum = "Lorem ipsum dolor sit amet, at mei dolore tritani repudiandae. In his nemore temporibus consequuntur, vim ad prima lorem ipsum sit vivendum consetetur.";;
	...
	return array(
		...
		"edit_this_text_in_customizer"      => $linnet_title,
		'lorem_ipsum'                       => $linnet_lorem_ipsum,
		...
		'blog_post_thumb_placeholder_color' => 'rgb(201, 207, 208)',
		'assets_js_key'                     => "linnetFrontendData",

		'default_icon'                      => $linnet_theme_svg_icons['fort-awesome'],
		'icons'                             => $linnet_theme_svg_icons,
		'divider_style'                     => $linnet_theme_divider_style,
		"gradients"                         => array(
			'night_fade'  =>
				array(
					'name'  => 'night_fade',
			...
			'header-menu' => array(
				...
				'props' => array(
					'hoverEffect' => array(
						...
						'group' => array(
							'border' => array(
								'transition' => 'bordered-active-item bordered-active-item--bottom'
							)
						)
					)
				)
			...
			"social_icons" => array(
				...
				"localProps" => array(
					"icons" => json_encode( array(
						array(
							'icon'       => $linnet_theme_svg_icons['facebook-2'],
							'link_value' => 'http://www.facebook.com/',
							'index'      => 0,
						),
						array(
							'icon'       => $linnet_theme_svg_icons['twitter-x'],
							'link_value' => '#',
							'index'      => 1,
						),
						array(
							'icon'       => $linnet_theme_svg_icons['instagram'],
							'link_value' => '#',
							'index'      => 2,
						),
						array(
							'icon'       => $linnet_theme_svg_icons['youtube-play'],
							'link_value' => '#',
							'index'      => 3,
						),
					) ),
			...
			"icon_list"    => array(
				...
				"localProps" => array(
					"iconList" => json_encode( array(
						array(
							'icon'       => $linnet_theme_svg_icons['map-marker-light'],
							'text'       => 'Location, State, Country',
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $linnet_theme_svg_icons['phone-2'],
							'text'       => '(000) 123 12345',
							'link_value' => 'tel:00012312345',
							'index'      => 1,
						),
						array(
							'icon'       => $linnet_theme_svg_icons['envelope-2'],
